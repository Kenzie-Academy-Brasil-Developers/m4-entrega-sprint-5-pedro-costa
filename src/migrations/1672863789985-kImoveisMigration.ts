...
export class kImoveisMigration1672863789985 implements MigrationInterface {
    name = 'kImoveisMigration1672863789985'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "schedules_users_properties" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "date" TIMESTAMP NOT NULL, "hour" TIME NOT NULL, "propertyId" character varying NOT NULL, "userId" character varying NOT NULL, CONSTRAINT "PK_2da5f1690059bb0f1aa60ec79fb" PRIMARY KEY ("id", "propertyId", "userId"))`);
